if (NOT KDECI_CA_BUNDLE_ARG)
    message(FATAL_ERROR "KDECI_CA_BUNDLE_ARG argument is not set!")
endif()

message("xxx")
message(${KDECI_CA_BUNDLE_ARG})
message("${KDECI_CA_BUNDLE_ARG}")
message("xxx")
...
message(STATUS "Downloading Mozilla CA certificate bundle to ${KDECI_CA_BUNDLE_ARG}...")
file(DOWNLOAD
