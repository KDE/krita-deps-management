...
if not arguments.android_abi is None:
    environmentUpdate['KDECI_PACKAGE_PROJECT'] = 'groups/teams/ci-artifacts/krita-android-{}'.format(arguments.android_abi)
    ...
    if sys.platform == 'win32':
        environmentUpdate['KDECI_PACKAGE_PROJECT'] = 'groups/teams/ci-artifacts/krita-windows'
    elif sys.platform == "darwin":
        environmentUpdate['KDECI_PACKAGE_PROJECT'] = 'groups/teams/ci-artifacts/krita-macos'
    else:
        environmentUpdate['KDECI_PACKAGE_PROJECT'] = 'groups/teams/ci-artifacts/krita-appimage'
